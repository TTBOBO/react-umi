...
class Form extends Component {
    ...
    componentWillMount(){
        ...
        this.setState({
            formOption:{
                formList:[
                    {label:"用户名",type:"number",value:'11',field:"username",hidden:false,render:false,addonBefore:"测试",suffix:"tip"},
                    ...
                    {label:"上传文件",type:"custom",value:'1',field:"upload" ,validate: "",render:this.upload}
